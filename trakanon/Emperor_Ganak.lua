...
function event_trade(e)
	...
	if(item_lib.check_turn_in_nomq(e.self, e.trade, {item1 = 19951, item2 = 19952}, 0)) then
	...
	elseif(item_lib.check_turn_in_nomq(e.self, e.trade, {item1 = 7276, item2 = 19953, item3 = 19954, item4 = 19955})) then
