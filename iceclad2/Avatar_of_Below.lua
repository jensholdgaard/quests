function event_trade(e)
	...
	if(item_lib.check_turn_in_nomq(e.self, e.trade, {item1 = 1199}, 0) or item_lib.check_turn_in_nomq(e.self, e.trade, {item1 = 8895}, 0)) then -- Runed Coldain Prayer Shawl (mark A or mark B)
