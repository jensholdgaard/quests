...
function event_trade(e)
	...
	if(eq.is_the_shadows_of_luclin_enabled() and item_lib.check_turn_in(e.self, e.trade, {item1 = 20293})) then -- Orc Thaumaturgists Spell Book
	...
	elseif(eq.is_the_shadows_of_luclin_enabled() and item_lib.check_turn_in(e.self, e.trade, {item1 = 20296,item2 = 20271,item3 = 20274})) then
