...
function event_trade(e)
	...
	if(e.other:GetFactionValue(e.self) >= -58) then --True Spirit
		if(e.other:GetLevel() >= 46 and item_lib.check_turn_in(e.self, e.trade, {item1 = 14367, item2 = 14368, item3 = 14369, item4 = 14370})) then --Corrupted Ghoulbane, Heart of the Innocent, Head of the Valiant, Will of Innoruuk
